# spec/integration/inspection_check_lists_spec.rb
require 'swagger_helper'

########## 
describe 'Inspection check lists API' do

  ####### Inpsection check lists ##########
  path '/inspection_check_lists/{tool_ID} ' do
    ...
    get 'Get a inspection_check_lists' do
      tags 'Tool'
