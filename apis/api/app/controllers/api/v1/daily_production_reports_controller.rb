class Api::V1::DailyProductionReportsController < ApplicationController
  before_action :authenticate

  def get_om
    start_date = params[:val1]
    end_date = params[:val2]
    service = Services::DailyProductionReport.new(start_date, end_date, asset_id)
  ...
  def get_real_strokes_tool
    ...
    service = Services::DailyProductionReport.new(start_date, end_date, asset_id, tool, work_order_id)
