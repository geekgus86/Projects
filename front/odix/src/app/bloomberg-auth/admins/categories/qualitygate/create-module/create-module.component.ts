import { Component, OnInit, OnDestroy, ElementRef, ViewChild, ViewEncapsulation, Inject  } from '@angular/core';
...
export class CreateModuleComponent implements OnInit, OnDestroy {
  ...
  imagePath: any;
  imgURL: any;
  imageTypeMessageAlert: boolean = false;
  imageSizeMessageAlert: boolean = false;
  ...
  width: any = 0;
  height: any = 0; 
  imageResolutionMessageAlert: boolean = false;

  constructor(private translateService: TranslateService, @Inject(DOCUMENT) private document:any, private route: ActivatedRoute,private router: Router, private createModuleService: CreateModuleService) {
    translateService.setDefaultLang('es-MX');
  ...
  open() {
    ...
    ////console.log('BOTONESxPOINTS')
    ////console.log(this.ButtonsXPoints)
    ////console.log('WELDPOINTLIST')
  ...
  preview(files: any) {
    ...
    if (mimeType != 'image/jpeg' && mimeType != 'image/jpg' && mimeType != 'image/png') {
      this.imageTypeMessageAlert = true;
      setTimeout(() => {
        this.imageTypeMessageAlert = false;
      }, 3000);
      ...
      setTimeout(() => {
        ...
        if(size > 2097152){
          this.imageSizeMessageAlert = true;
          setTimeout(() => {
            this.imageSizeMessageAlert = false;
          }, 3000);
          return;
        }
        
        else if(this.height > 462){
          this.imageResolutionMessageAlert = true;
          setTimeout(() => {
            this.imageResolutionMessageAlert = false;
          }, 3000);
          return;
        }else{
          ...
          this.imageName = this.imagePath[0].name;
  ...
  getInspectionPoints(){
    this.createModuleService.getEnabledInspectionPoints()
      .subscribe(data => {
  ...
  getAssets(){
    this.createModuleService.getStations()
      .subscribe(data => {
  ...
  saveModule(){
    if(this.imgURL == null || this.imgURL == undefined || this.selectedLineOnCombo == undefined || this.selectedEnnOnCombo == undefined || this.selectedStationOnCombo == undefined || this.selectedOperatorPosition == undefined){
      ////console.log("All comboboxes need a value")
      return;
    }
    else{
      ...
      ////console.log(this.imgURL)
      ////console.log("Line ID")
      ////console.log(this.selectedLineOnCombo.ID)
      ////console.log("ENN ID")
      ////console.log(this.selectedEnnOnCombo.ID)
      ////console.log("STATION ID")
      ////console.log(this.selectedStationOnCombo.ID)
      ////console.log("OP POSITION")
      ////console.log(this.selectedOperatorPosition)
      ////console.log("Image Name")
      ////console.log(this.imageName)
      //alert('Modulo creado(not really)');
      ...
      postJSON = {
        ...
        "imageByteArray": this.imgURL,
        "imageName": this.imageName,
        "inspectionPoints": inspectionPointsJSON
      };

      ////console.log("POST JSONNNN")
      ////console.log(postJSON)

      this.createModuleService.createModule(postJSON)
        .subscribe(res => {      
  ...
  processAssetsJson(json: any){
    ...
    //console.log("line combo")
    //console.log(this.lineCombo)
    //console.log("enn combo")
    //console.log(this.ennCombo)
    //console.log("station combo")
    //console.log(this.stationCombo)
