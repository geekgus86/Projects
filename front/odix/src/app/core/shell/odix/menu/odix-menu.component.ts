...
@Component({
  ...
  selector: 'odix-menu',
  templateUrl: './odix-menu.component.html',
  styleUrls: ['./odix-menu.component.scss']
})
export class OdixMenuComponent implements OnInit, AfterViewInit {
  ...
  constructor(private scrollbarService: MalihuScrollbarService,private route: ActivatedRoute, private menuService: OdixMenuService) { 
      console.log("======== ODIX MENU COMPONENT =========")
      this.suggestion = "";
