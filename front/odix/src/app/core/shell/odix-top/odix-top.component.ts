...
@Component({
  selector: 'app-odix-top',
  templateUrl: './odix-top.component.html',
  styleUrls: ['./odix-top.component.scss']
})
export class OdixTopComponent implements OnInit, AfterViewInit {
