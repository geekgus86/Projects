...
import { fetchShifts, fetchShiftsRealStrokesHeader, fetchDowntimesPerArea, fetchRealStrokesHeader, fetchDailyReportDetail, fetchToolReports, fetchRollos } from "../../store/dailyReport/actions";
    ...
    if (this.state.loading === false) {
      content = (
        <React.Fragment>
          ...
          {
            this.props.shiftsStrokes && this.props.shiftsStrokes.map(shiftStrokes => {
              return (
                <DailyReportTable 
            ...
            <div className={styleDaily.AreaSummary}>
              ...
              <div className={styleDaily.AreasFooter}>
                <div>
                  ...
                  <span className={styleDaily.ValueLabel}>{ ((this.props.summary) ? this.props.summary.time_tnr.toFixed(2) : 0) } min</span></div>
                <div className={styleDaily.BoldCell}>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ fetchShifts, fetchShiftsRealStrokesHeader, fetchDowntimesPerArea, fetchRealStrokesHeader, fetchDailyReportDetail, fetchToolReports, fetchProfile, fetchRollos }, dispatch);
}
