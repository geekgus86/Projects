...
<script type="text/javascript" src="js/candidaturas_scripts.js"></script>
...
<body class="tundra" onload="pinta()">
	...
	<div id="cuenta_izq_home_usu">
		...
		<div id="encabezado" class="encabezado_datos_P">
			<div class="avatar"><img id="foto_user" name="foto_user" src="<s:property value="urlFoto"/>" width=120 height=120  style=" margin-left:3px; margin-top:15px;" /></div>
			<div class="datos">
				<h1>Datos Personales</h1>
				
				<label>Nombre:</label><span><s:property value='nombre'/></span><br/>
				<label>RFC:</label><span><s:property value='rfc'/></span><br/>
				<label>CURP:</label><span><s:property value='curp'/></span><br/>
				<label>Sexo:</label><span><s:property value='sexo'/></span><br/>
			</div><br/>
		</div>
		...
		<div id="cuerpo" class="cuerpo_datos_P">
		  <div class="contenedor2">
		  	 	...
		  	 	<div class="contenedor_encabezado2">
		  	 		<h1>Tus Candidaturas Actuales son:</h1>
		  	 	</div>
		  	 	...
		  	 	<div id="contieneAcordion">
		  	 		<div id="accordion">
		  	 			<s:iterator id="listado" value="vacantes1" status="it">
 						  <h3 class="retrae" id="<s:property value='vacantes1[#it.index]'/>"> <span class="fIqd" id="Fle<s:property value='vacantes1[#it.index]'/>"></span>  <a><s:property value='vacantes2[#it.index]'/></a>   <span id="miVacEsta"  class="estaVac<s:property value='listaEstadoVac[#it.index]'/>"></span>      <span id="<s:property value='vacantes1[#it.index]'/>" class="elimPostu">Eliminar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X</span></h3>
						  <div class="divDesple"> 
			...
			<div class="destacados">
			    ...
			    <div id="tabbed_box_1" class="tabbed_box">  
			        ...
			        <div class="tabbed_area">  
			            ...
			            <div id="nacionales" class="contentT">
