...
public class perfilUsuario extends ActionSupport implements SessionAware{
    ...
    public String execute(){
    	...
    	String parameter = escapeChars(request.getParameter("idUsuario"));
        ...
        for (Object object : data) {
        	Map row = (Map) object;
        	  ...
        	  this.correous=(String)row.get("correo_electronico");
        ...
        String sql2 = "SELECT \"datos_personales\".\"rfc\",\"datos_personales\".\"curp\",\"datos_personales\".\"sexo\",\"datos_personales\".\"estado_civil\" FROM \"datos_personales\"WHERE \"datos_personales\".\"id_usuario\"= :parameter ";
        Query query2 = session.createSQLQuery(sql2);
        
        query2.setParameter("parameter", parameter);
        ...
        String sql8 = "SELECT \"Ubicacion\".\"calle_numero\",\"Ubicacion\".\"colonia\",\"Ubicacion\".\"municipio_delegacion\",\"Ubicacion\".\"cp\",\"Ubicacion\".\"ciudad_poblado\",\"Ubicacion\".\"estado\",\"Ubicacion\".\"nacionalidad\" FROM \"Ubicacion\"WHERE \"Ubicacion\".\"id_usuario\"= :parameter ";
        Query query8 = session.createSQLQuery(sql8);
        
        query8.setParameter("parameter", parameter);
        ...
        String sql5 = "SELECT \"idioma_aux\".\"id_idioma_aux\",\"idioma\".\"idioma\", \"idioma_aux\".\"dominio\", \"idioma\".\"id_idioma\" FROM \"idioma\",\"idioma_aux\" WHERE \"idioma_aux\".\"id_usuario\"= :parameter  AND \"idioma_aux\".\"id_idioma\"=\"idioma\".\"id_idioma\"";
        Query query5 = session.createSQLQuery(sql5);
        
        query5.setParameter("parameter", parameter);
        ...
        String sql9usu = "SELECT \"identidad\".\"identidad\",\"identidad\".\"id_identidad\" FROM \"identidad\", \"identidad_aux\" WHERE \"identidad\".\"categoria_identidad\"='Persuasion' AND \"identidad_aux\".\"id_identidad\"=\"identidad\".\"id_identidad\" AND \"identidad_aux\".\"id_usuario\"= :parameter ";
        Query query9usu = session.createSQLQuery(sql9usu);
        
        query9usu.setParameter("parameter", parameter);
        ...
        String sql10usu = "SELECT \"identidad\".\"identidad\",\"identidad\".\"id_identidad\" FROM \"identidad\" ,\"identidad_aux\" WHERE \"identidad\".\"categoria_identidad\"='Constancia' AND \"identidad_aux\".\"id_identidad\"=\"identidad\".\"id_identidad\" AND \"identidad_aux\".\"id_usuario\"= :parameter ";
        Query query10usu = session.createSQLQuery(sql10usu);
        
        query10usu.setParameter("parameter", parameter);
        ...
        String sql11usu = "SELECT \"identidad\".\"identidad\",\"identidad\".\"id_identidad\" FROM \"identidad\",\"identidad_aux\" WHERE \"identidad\".\"categoria_identidad\"='Apego' AND \"identidad_aux\".\"id_identidad\"=\"identidad\".\"id_identidad\" AND \"identidad_aux\".\"id_usuario\"= :parameter ";
        Query query11usu = session.createSQLQuery(sql11usu);
        
        query11usu.setParameter("parameter", parameter);
        ...
        String sql12usu = "SELECT \"identidad\".\"identidad\",\"identidad\".\"id_identidad\" FROM \"identidad\", \"identidad_aux\" WHERE \"identidad\".\"categoria_identidad\"='Empuje' AND \"identidad_aux\".\"id_identidad\"=\"identidad\".\"id_identidad\" AND \"identidad_aux\".\"id_usuario\"= :parameter ";
        Query query12usu = session.createSQLQuery(sql12usu);
        
        query12usu.setParameter("parameter", parameter);
    	...
    	String sqlUsuSoft = "SELECT \"software_aux\".\"id_aux\",\"software\".\"nombre\",\"software_aux\".\"dominio\" FROM \"software\",\"software_aux\" WHERE  \"software\".\"id_software\"=\"software_aux\".\"id_software\" AND \"software_aux\".\"id_usuario\"= :parameter ";
        Query queryUsuSoft = session.createSQLQuery(sqlUsuSoft);
        
        queryUsuSoft.setParameter("parameter", parameter);
        ...
        String sqlDis = "SELECT \"disposicion\".\"viajar\",\"disposicion\".\"mudarse\"  FROM \"disposicion\" WHERE  \"disposicion\".\"id_usuario\"= :parameter ";
	     Query queryDis = session.createSQLQuery(sqlDis);
	        
	     queryDis.setParameter("parameter", parameter);
	     ...
	     String sqlSal = "SELECT \"salario_deseado\".\"salario_deseado\"  FROM \"salario_deseado\" WHERE  \"salario_deseado\".\"id_usuario\"= :parameter ";
	     Query querySal = session.createSQLQuery(sqlSal);
	        
	     querySal.setParameter("parameter", parameter);
	     ...
	     String sqlHor = "SELECT \"horario_preferido\".\"horario_preferido\"  FROM \"horario_preferido\" WHERE  \"horario_preferido\".\"id_usuario\"= :parameter ";
	     Query queryHor = session.createSQLQuery(sqlHor);
	     
	        
	     queryHor.setParameter("parameter", parameter);
	     ...
	     String sqlSkill="SELECT \"habilidad\".\"id_aux_habilidad\",\"habilidad\".\"habilidad\" FROM \"habilidad\" WHERE \"habilidad\".\"id_usuario\"= :parameter ";
	     Query querySkill = session.createSQLQuery(sqlSkill);
	        
	     querySkill.setParameter("parameter", parameter);
        ...
        String sql3 = "SELECT \"foto\".\"url_foto\"FROM \"foto\"WHERE \"foto\".\"id_usuario\"= :parameter ";
        Query query3 = session.createSQLQuery(sql3);
        
        query3.setParameter("parameter", parameter);
