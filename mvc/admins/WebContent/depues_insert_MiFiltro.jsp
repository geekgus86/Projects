...
<script type="text/javascript" src="js/despues_postularMiFiltro_scripts.js"></script>
<title>Resultados Agregar Filtro</title>
</head>
<body>
	
	<div id="content"> 
		<div id="content-adm">
			<span><a href="/admins/HomeAdmin">Men&uacute; Principal - </a><a href="/admins/UsuariosAdmin">Administaci&oacute;n de Usuarios - </a><a href="/admins/Candidatos">Candidatos - </a></a></span>
			<h1>Resultados Mi Filtro</h1>
			...
			<div class="campo_form3">
			    ...
			    <a href="javascript:history.back(1);" class="btnCan" style="color:#FFFFFF;font-size: 14px;">Mis Postulante</a>
			    <div id="ver_postulantes" class="btnCan" style="color:#FFFFFF;font-size: 14px;">Ver Mi Filtro</div>
