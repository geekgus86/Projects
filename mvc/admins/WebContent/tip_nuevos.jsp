...
<script type="text/javascript" src="js/nuevo_tip.js"></script>
...
<body>
		...
		<div id="content-adm">
			...
			<div class="instrucciones">Introdusca el Tip</div><br/>
			
			<div class="campo_form1_tip">
				<form theme="simple" id="form_tip_nuevo" action="TipsGuardar" method="POST" accept-charset="utf-8">
					<label>Descripci&oacute;n del Tip (255 Caracteres):</label><s:textarea cssClass="area_text" name="textoTip" id="textoTip"></s:textarea><br/>
					<label>Tipo de Tip:</label><select id="tipoTip" name="tipoTip">
