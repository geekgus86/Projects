...
<body>
	...
	<div id="content"> 
		<div id="content-adm">
			...
			<h3>Vacante ingresada con &eacute;xito</h3>
			
			<p>La vacante se ingres&oacute; con los siguientes datos, de clic en el folio para desplegar toda la informaci&oacute;n.</p>
